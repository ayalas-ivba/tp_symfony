...
/* login.html.twig */
class __TwigTemplate_16b2969db714656c83eab1e2a346649fbe9b2a074606626b2fbabd17856f405c extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 3
        echo "    <form action=\"login_curso\" method=\"post\">
        <label>email</label>
...
{% block body %}
    <form action=\"login_curso\" method=\"post\">
        <label>email</label>
        <input type=\"text\" id=\"email\" name=\"email\">
        <label>password</label>
        <input type=\"password\" id=\"password\" name=\"password\">
...
{% endblock %}", "login.html.twig", "/opt/lampp/htdocs/curso_symfony_4/templates/login.html.twig");
    }
}
